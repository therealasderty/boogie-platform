...
const PHONES = ['+39 039 9260568', '+39 346 5813309']
...
export default async function SezioneVieni() {
  const [orari, chiusure] = await Promise.all([fetchOrari(), fetchChiusure()])
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <FadeIn>
            ...
            <h2
              className="font-raleway font-semibold text-neutral-900 mt-4 mb-2 leading-tight"
                ...
                <div>
                  ...
                  {orariDisplay.avvisoSettimana && (
                    <Link
                      ...
                      className="text-brand/80 mt-2 hover:underline underline-offset-2"
          ...
          {/* Mappa */}
          <FadeIn delay={0.1}>
            <div className="rounded-card overflow-hidden border border-neutral-200 h-full min-h-[320px]">
              <iframe
