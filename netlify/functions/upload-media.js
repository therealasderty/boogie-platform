...
// Carica un'immagine media (permanente) su Cloudflare R2.
// Stessa infrastruttura di upload-slide.js ma prefisso 'media/' — nessuna scadenza.
//
// Env vars richieste (stesse di upload-slide):
...
exports.handler = async (event) => {
  ...
  const headers = sigV4Sign({
    method: 'PUT', url: r2Url, body: fileBuffer,
    contentType: ct, accessKeyId: R2_ACCESS_KEY_ID, secretAccessKey: R2_SECRET_ACCESS_KEY,
  })
